...
import predicates.GradeBetterThanPredicate;
import predicates.GradeWorseThanPredicate;
import predicates.IndexNumberGreaterThanPredicate;
import predicates.IndexNumberPredicate;
import utils.*;
import iterators.*;
...
public class ExerciseTests {
    public static void main(String[] args){
        ...
        MyListIterator<Student> studentList = new MyListIterator<Student>(students);
